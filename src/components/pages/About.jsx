  ...
  return (
    <section id='about-page' className='about' aria-label='About page'>
      <div className='about__text'>
        ...
        <p className='about__paragraph'>I got into programming by coincidence. While I was happily working in a grocery store, my brother sign me
          up
          for an exam
          to join a programming school. I passed the exam, and since I started school I couldn't stop looking for
          how
          things were
          made.
        </p>
